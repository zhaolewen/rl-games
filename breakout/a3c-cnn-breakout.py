            ...
            while not coord.should_stop():
                ...
                while True:
                    ...
                    if done:
                        ...
                        sendStatElastic({"score": ep_score,'agent_name':self.name, 'game_name': 'ac3-Breakout-v0', 'episode': ep_count,'frame_count':total_step})
                        break
            ...
            while not coord.should_stop() and ep_count<max_episode_count:
                ...
                while True:
                    ...
                    if done:
                        ...
                        sendStatElastic({"score": ep_score,'game_name': 'ac3-Breakout-v0','episode':ep_count,'rand_e_prob':100.0*e,'agent_name':self.name,'frame_count':total_step})
                        break
